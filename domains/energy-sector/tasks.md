...
- [x] Create plan.md
- [x] Create tasks.md
- [x] Create ubiquitous-language.md
...
- [x] transmission-distribution-context
- [x] trading-market-context
- [x] metering-billing-context
- [x] regulatory-grid-context
- [x] renewable-integration-context
